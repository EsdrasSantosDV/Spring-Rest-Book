...
//SERVE COMO HANDLER PRA TODOS OS CONTROLLERS PRA MOSTRAR OS ERROS, TNATO DE VALIDATOR QUANTO DE JPA
@ControllerAdvice
public class CustomErrorController {
    ...
    ResponseEntity handleJPAViolations(TransactionSystemException exception){
        ...
        if(exception.getCause().getCause() instanceof ConstraintViolationException){
            ...
            List errorList = violationException.getConstraintViolations().stream()
